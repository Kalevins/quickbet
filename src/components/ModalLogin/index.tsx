          ...
          >
              ...
              {activeOption !== activeOptions.logout && (
                <div className={styles.buttonsContainer}>
                  <button
                    ...
                    id={
                      activeOption === activeOptions.signUp ? styles.active : ""
                    }
                    onClick={() => {
                      setError("");
                      setSignUpOption("");
                  ...
                  <button
                    className={styles.button}
                    id={
                      activeOption === activeOptions.login ? styles.active : ""
                    }
                    onClick={() => {
                      setError("");
            ...
            {activeOption === activeOptions.logout && (
              <div className={styles.infoContainer}>
                <h1>Goodbye!</h1>
                <p>
                  🎥 Thank you for choosing Quickbet Movies! We hope you had a
                  great time with us. See you soon!
                </p>
                <div className={styles.imageContainer}>
                  <Image
                    className={styles.image}
